...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-4ojt60k.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-4ojt60k.containers.anotherwebservice.com/
...
```
git clone git@github.com:wanbao118/container-4ojt60k.git
cd container-4ojt60k
```
...
```
docker attach container-4ojt60k
```
